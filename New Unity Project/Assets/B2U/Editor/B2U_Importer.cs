// Blender To Unity Importer v1.3
// Cogumelo Softworks 2018
...
class B2U_Postprocessor : AssetPostprocessor {
    ...
    Material OnAssignMaterialModel(Material material, Renderer renderer) {
        ...
        if (path_mat != "") {
            ...
            if (updateProperties) {
                ...
                // Base Color
                if (mode.InnerText == "Principled" || mode.InnerText == "Emission" || mode.InnerText == "Diffuse") {
                ...
                // Transparent
                if (mode.InnerText == "Principled" || mode.InnerText == "Diffuse") {
                    string value = channels.SelectSingleNode("_Transparent").InnerText;
                    if(value == "Opaque") {mat.SetFloat("_Mode", 0.0f); }
                    if (value == "Cutout") { mat.SetFloat("_Mode", 1.0f); }
                    if (value == "Fade") { mat.SetFloat("_Mode", 2.0f); }
                    if (value == "Transparent") { mat.SetFloat("_Mode", 3.0f); }
                }
            }
            return mat;
        }
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths) {
        ...
        Debug.Log("B2U Import Process Finished");
    }
}
